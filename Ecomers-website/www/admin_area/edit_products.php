...
<div class="container mt-5">
    <h1 class="text-center">Редагувати товар</h1>
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            <label for="product_desc" class="form-label">Опис товару</label>
        ...
        <div class="form-outline w-50 m-auto mb-4">
            <label for="product_category" class="form-label">Жанри</label>
        ...
        <div class="form-outline w-50 m-auto mb-4">
            <label for="product_brands" class="form-label">Література</label>
        ...
        <div class="w-50 m-auto">
            ...
            <script>
                ...
                submitButton.value = "Оновити товар";
            </script>
        </div>
    </form>
</div>
...
if(isset($_POST['edit_product'])){
    ...
    if($product_title=='' or $product_desc=='' or $product_keywords=='' or $product_category=='' or $product_brands=='' or $product_price==''){
        echo "<script>alert('Будь ласка, заповніть всі поля і продовжуйте процес')</script>";
    }else{
        if(!empty($product_image1)){
            move_uploaded_file($temp_image1,"./product_images/$product_image1");
            $update_product_image1 = ", product_image1='$product_image1'";
        } else {
            $update_product_image1 = "";
        }

        if(!empty($product_image2)){
            move_uploaded_file($temp_image2,"./product_images/$product_image2");
            $update_product_image2 = ", product_image2='$product_image2'";
        } else {
            $update_product_image2 = "";
        }

        if(!empty($product_image3)){
            move_uploaded_file($temp_image3,"./product_images/$product_image3");
            $update_product_image3 = ", product_image3='$product_image3'";
        } else {
            $update_product_image3 = "";
        }
        ...
        if($result_update){
            echo "<script>alert('Товар успішно оновлено')</script>";
