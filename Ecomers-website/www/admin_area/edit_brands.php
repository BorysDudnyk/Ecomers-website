...
if(isset($_POST['edit_brands'])){
    ...
    if($result_brand){
        echo "<script>alert('Література успішно оновлена')</script>";
...
<div class="container mt-3">
    <h1 class="text-center">Редагувати літературу</h1>
    <form action="" method="post" class="text-center">
        <div class="form-outline mb-4 w-50 m-auto">
            <label for="brand_title" class="form-label">Назва літератури</label>
            <input type="text" name="brand_title" id="brand_title" class="form-control" required="required" value="<?php echo $brand_title; ?>">
        </div>
        <input type="submit" value="Оновити літературу" class="btn btn-info px-3 mb-3" name="edit_brands">
    </form>
</div>
