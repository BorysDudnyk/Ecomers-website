...
<body>
    <div class="container-fluid my-3">
        <h2 class="text-center">Вхід нового користувача</h2>
            ...
            <div class="col-lg-12 col-xl-6">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" id="user_username" class="form-control" placeholder="Введіть ваше ім'я користувача" autocomplete="off" required="required" name="user_username"/>
                    </div>
                    <!-- password field -->
                    <div class="form-outline mb-4">
                    ...
                    <div class="mt-4 pt-2">
                        ...
                        <script>
                            ...
                            submitButton.value = "Увійти";
                        </script>
                        <p class="small fw-bold mt-2 pt-1 mb-0">Не маєте облікового запису? <a href="user_registration.php" class="text-danger"> Зареєструватися</a></p>
                    </div>
                </form>
            </div>
        </div>
