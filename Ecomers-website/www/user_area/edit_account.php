...
if(isset($_POST['user_update'])){
    ...
    if($result_query_update){
        echo "<script>alert('Дані успішно оновлено')</script>";
...
<body>
    <h3 class="text-success mb-4">Редагувати профіль користувача</h3>
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <input type="submit" value="Оновити" class="bg-info py-2 px-3 border-0" name="user_update">
    </form>
</body>
</html>